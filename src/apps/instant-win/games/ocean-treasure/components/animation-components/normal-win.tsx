...
import { normalWinAnimation, normalWinAnimationiOS, winPoster } from '../../assets';
...
export const NormalWin = () => {
  ...
  useEffect(() => {
    startMusic(Music.OTH_NORMAL_WIN, 150);
    return () => {
      stopAllAudio();
    };
  }, []);
  ...
  return (
    <div className={`winAnimationContainer normalWin`}>
      {videoTimeout ? (
        <img
          src={winPoster}
        ...
        >
          <source src={normalWinAnimationiOS} type={'video/quicktime'} />
          <source src={normalWinAnimation} type={'video/webm'} />
        </video>
      )}
